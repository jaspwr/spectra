...
_projects.push(deserialize(`{"name":"Situation","goals":[{"name":"Diffuse lighting","done":false},{"name":"Specular highlights","done":false},{"name":"Normal mapping","done":false},{"name":"Fog","done":false},{"name":"Shadows","done":false},{"name":"Bloom","done":false}],"shaders":[{"filename":"main.frag","contents":"#ifdef GL_ES\\nprecision highp float;\\n#endif\\n\\nvarying vec3 vNormal;\\nvarying vec2 vUv;\\n\\nuniform float time;\\n\\nvoid main() {\\n    vec3 lightDirection = vec3(cos(time), -0.4, sin(time));\\n    float ambientLight = 0.1;\\n    vec3 brown = vec3(.54, .27, .07);\\n    float lightness = -clamp(dot(normalize(vNormal), normalize(lightDirection)), -1., 0.);\\n    lightness = ambientLight + (1. - ambientLight) * lightness;\\n    float spec = pow(lightness, 50.);\\n    gl_FragColor = vec4(brown * lightness + spec, 1.);\\n}"},{"filename":"main.vert","contents":"attribute vec3 position;\\nattribute vec3 normal;\\nattribute vec2 uv;\\nuniform mat4 model;\\nuniform mat4 view;\\nuniform mat4 projection;\\nvarying vec3 vNormal;\\nvarying vec2 vUv;\\n\\nvoid main() {\\n    vUv = uv;\\n    vNormal = (model * vec4(normal, 0.)).xyz;\\n    gl_Position = projection * view * model * vec4(position, 1.);\\n}"},{"filename":"quad.vert","contents":"#version 100\\n\\nattribute vec4 position;\\n\\nvarying vec2 uvCoords;\\n\\nvoid main(void) {\\n    uvCoords = (position.xy + 1.0)/2.0;\\n    gl_Position = position;\\n}\\n"},{"filename":"out.frag","contents":"#version 100\\n\\n#ifdef GL_ES\\nprecision highp float;\\n#endif\\n\\nuniform float time;\\n\\nvarying vec2 uvCoords;\\nuniform sampler2D t;\\n\\nvoid main(void) {\\n    vec3 col = texture2D(t, uvCoords).rgb;\\n    gl_FragColor = vec4(col, 1.0);\\n}\\n"}],"pipelineGraph":{"nodes":[{"id":"0.8398805551003263","type":"shader","position":{"x":-389,"y":125},"data":{"label":"shader node","shaderId":7},"origin":[0.5,0],"measured":{"width":222,"height":68},"selected":false,"dragging":false},{"id":"0.16173032208604377","type":"shader","position":{"x":11,"y":-150},"data":{"label":"shader node","shaderId":8},"origin":[0.5,0],"measured":{"width":222,"height":101},"selected":false,"dragging":false},{"id":"0.31520863567991997","type":"gl-program","position":{"x":211,"y":-25},"data":{"label":"gl-program node"},"origin":[0.5,0],"measured":{"width":122,"height":80},"selected":false,"dragging":false},{"id":"0.7079005235784883","type":"uniform","position":{"x":-219,"y":-250},"data":{"label":"uniform node","type":"view","x":5,"y":3,"z":5,"targetX":0,"targetY":0,"targetZ":0,"upX":0,"upY":1,"upZ":0},"origin":[0.5,0],"measured":{"width":162,"height":222},"selected":false,"dragging":false},{"id":"0.5621413967099553","type":"uniform","position":{"x":-219,"y":0},"data":{"label":"uniform node","type":"projection","fov":45,"near":0.1,"far":100},"origin":[0.5,0],"measured":{"width":162,"height":101},"selected":false,"dragging":false},{"id":"0.6581115910459696","type":"geometry","position":{"x":31,"y":100},"data":{"label":"geometry node","type":"Model","uniformOverrides":["model"],"modelSrc":"sphere.obj"},"origin":[0.5,0],"measured":{"width":162,"height":147},"selected":false,"dragging":false},{"id":"0.532574107694253","type":"uniform","position":{"x":-169,"y":175},"data":{"label":"uniform node","type":"translation","x":0,"z":-3},"origin":[0.5,0],"measured":{"width":162,"height":101},"selected":false,"dragging":false},{"id":"0.7446113371735203","type":"geometry","position":{"x":-44,"y":300},"data":{"label":"geometry node","type":"Model","uniformOverrides":["model"],"modelSrc":"monkey.obj"},"origin":[0.5,0],"measured":{"width":162,"height":147},"selected":false,"dragging":false},{"id":"0.6104713280508203","type":"uniform","position":{"x":-269,"y":300},"data":{"label":"uniform node","type":"translation"},"origin":[0.5,0],"measured":{"width":162,"height":101},"selected":false,"dragging":false},{"id":"0.6869172561404668","type":"uniform","position":{"x":-644,"y":150},"data":{"label":"uniform node","type":"time"},"origin":[0.5,0],"measured":{"width":162,"height":40},"selected":false,"dragging":false},{"id":"0.15917140501318938","type":"geometry","position":{"x":-44,"y":475},"data":{"label":"geometry node","type":"Model","uniformOverrides":["model"],"modelSrc":"cube.obj"},"origin":[0.5,0],"measured":{"width":162,"height":147},"selected":false,"dragging":false},{"id":"0.6493829668983515","type":"uniform","position":{"x":-244,"y":475},"data":{"label":"uniform node","type":"translation","z":0,"x":-2,"y":-0.4},"origin":[0.5,0],"measured":{"width":162,"height":101},"selected":false,"dragging":false},{"id":"0.03803812779574911","type":"framebuffer","position":{"x":298.5,"y":125},"data":{"label":"framebuffer node"},"origin":[0.5,0],"measured":{"width":97,"height":38},"selected":true,"dragging":false},{"id":"0.27998964124944403","type":"gl-program","position":{"x":736,"y":0},"data":{"label":"gl-program node"},"origin":[0.5,0],"measured":{"width":122,"height":80},"selected":false,"dragging":false},{"id":"0.3479303161661913","type":"geometry","position":{"x":556,"y":175},"data":{"label":"geometry node","type":"Screen Quad","uniformOverrides":[]},"origin":[0.5,0],"measured":{"width":162,"height":91},"selected":false,"dragging":false},{"id":"0.8381056525732367","type":"shader","position":{"x":511,"y":75},"data":{"label":"shader node","shaderId":10},"origin":[0.5,0],"measured":{"width":222,"height":84},"selected":false,"dragging":false},{"id":"0.9187652341417212","type":"shader","position":{"x":511,"y":-50},"data":{"label":"shader node","shaderId":9},"origin":[0.5,0],"measured":{"width":222,"height":52},"selected":false,"dragging":false},{"id":"0.4673470603851595","type":"window","position":{"x":875,"y":50},"data":{"label":"window node"},"origin":[0.5,0],"measured":{"width":87,"height":38},"selected":false}],"edges":[{"source":"0.16173032208604377","target":"0.31520863567991997","targetHandle":"vert","id":"xy-edge__0.16173032208604377-0.31520863567991997vert","selected":false},{"source":"0.8398805551003263","target":"0.31520863567991997","targetHandle":"frag","id":"xy-edge__0.8398805551003263-0.31520863567991997frag","selected":false},{"source":"0.7079005235784883","target":"0.16173032208604377","targetHandle":"view","id":"xy-edge__0.7079005235784883-0.16173032208604377view","selected":false},{"source":"0.5621413967099553","target":"0.16173032208604377","targetHandle":"projection","id":"xy-edge__0.5621413967099553-0.16173032208604377projection","selected":false},{"source":"0.6581115910459696","sourceHandle":"__output","target":"0.31520863567991997","targetHandle":"geometry","id":"xy-edge__0.6581115910459696__output-0.31520863567991997geometry","selected":false},{"source":"0.532574107694253","target":"0.6581115910459696","targetHandle":"model","id":"xy-edge__0.532574107694253-0.6581115910459696model","selected":false},{"source":"0.532574107694253","target":"0.6581115910459696","id":"xy-edge__0.532574107694253-0.6581115910459696","selected":false},{"source":"0.7446113371735203","sourceHandle":"__output","target":"0.31520863567991997","targetHandle":"geometry","id":"xy-edge__0.7446113371735203__output-0.31520863567991997geometry","selected":false},{"source":"0.6104713280508203","target":"0.7446113371735203","targetHandle":"model","id":"xy-edge__0.6104713280508203-0.7446113371735203model","selected":false},{"source":"0.6104713280508203","target":"0.7446113371735203","id":"xy-edge__0.6104713280508203-0.7446113371735203","selected":false},{"source":"0.6869172561404668","target":"0.8398805551003263","targetHandle":"time","id":"xy-edge__0.6869172561404668-0.8398805551003263time","selected":false},{"source":"0.15917140501318938","sourceHandle":"__output","target":"0.31520863567991997","targetHandle":"geometry","id":"xy-edge__0.15917140501318938__output-0.31520863567991997geometry","selected":false},{"source":"0.6493829668983515","target":"0.15917140501318938","targetHandle":"model","id":"xy-edge__0.6493829668983515-0.15917140501318938model","selected":false},{"source":"0.6493829668983515","target":"0.15917140501318938","id":"xy-edge__0.6493829668983515-0.15917140501318938","selected":false},{"source":"0.31520863567991997","target":"0.03803812779574911","targetHandle":"in","id":"xy-edge__0.31520863567991997-0.03803812779574911in","selected":false},{"source":"0.3479303161661913","sourceHandle":"__output","target":"0.27998964124944403","targetHandle":"geometry","id":"xy-edge__0.3479303161661913__output-0.27998964124944403geometry","selected":false},{"source":"0.8381056525732367","target":"0.27998964124944403","targetHandle":"frag","id":"xy-edge__0.8381056525732367-0.27998964124944403frag","selected":false},{"source":"0.9187652341417212","target":"0.27998964124944403","targetHandle":"vert","id":"xy-edge__0.9187652341417212-0.27998964124944403vert","selected":false},{"source":"0.27998964124944403","target":"0.4673470603851595","targetHandle":"in","id":"xy-edge__0.27998964124944403-0.4673470603851595in","selected":false},{"source":"0.03803812779574911","sourceHandle":"out","target":"0.8381056525732367","targetHandle":"t","id":"xy-edge__0.03803812779574911out-0.8381056525732367t","selected":false}]}}`));
